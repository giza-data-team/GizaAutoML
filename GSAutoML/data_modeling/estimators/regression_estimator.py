...
class RegressionEstimator(IModelerEstimator):
    """
    A class for performing regression model training and prediction.
    ...
    Args:
        ...
        scoring_metric (RegressionScoringMetricEnum): The scoring metric for model evaluation.
    ...
    Methods:
        get_model_initialization: Get the regression algorithm initialization with specific hyperparameters.
    ...
    def __init__(self, label_col, prediction_col,timestamp_col_name, params, estimator,
                 scoring_metric: RegressionScoringMetricEnum, exclude_cols=None, hyperparameters=None,
                 algorithm_name=None):
        super().__init__()
        self.time_stamp_col_name = timestamp_col_name
    ...
    def get_model_initialization(self):
        ...
        regressors = Regressors(regressor_name=self.algorithm_name,label_col_name=self.label_col,
                                time_stamp_col_name=self.time_stamp_col_name)
        # get model instance initialized with hyperparameters
        estimator = regressors.get_best_regressor(hyperparameters=self.hyperparameters)
    ...
    def _get_best_model(self, x, y):
        ...
        grid_search = GridSearchCV(estimator=self.estimator,
                                   ...
                                   scoring=self.scoring_metric.value,
