...
from GSAutoML.enums.dataset_types_enums import DatasetTypeEnum
from GSAutoML.controller.meta_model_controllers.meta_model_with_saving import MetaModelWithSaving
from GSAutoML.controller.meta_model_controllers.meta_model_without_saving import MetaModelWithOutSaving
...
class AutoSeriesForecaster:
    ...
    def fit(self):
        if self.save_results_flag:
            self.meta_model = MetaModelWithSaving(raw_dataframe=self.dataframe,
            ...
            self.meta_model = MetaModelWithOutSaving(raw_dataframe=self.dataframe,
                                                     processed_dataframe=self.processed_dataframe,
                                                     sorting_metric=self.sorting_metric,
                                                     time_budget=self.time_budget,
                                                     random_seed=self.random_seed,
